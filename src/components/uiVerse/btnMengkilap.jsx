...
const ButtonMengkilap = ({ text, icon, className, bg, textColor, ring }) => {
  return (
    <button
      href="#"
      className={`flex overflow-hidden items-center text-sm font-medium cursor-pointer focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-${bg} text-${textColor} shadow h-fit md:px-4 px-2 py-2 whitespace-pre md:flex group relative justify-center gap-2 transition-all duration-300 ease-out  ${className}`}
    >
