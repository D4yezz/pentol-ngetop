  ...
  return (
    <>
      <motion.section
        ...
        className="flex flex-col lg:w-[55%] w-full lg:h-full h-fit lg:justify-center justify-start"
      >
        <h1 className="w-full font-semibold gradiasi-btn-merah text-transparent bg-clip-text flex flex-col font-poppins text-5xl lg:pb-12 pb-4 lg:pt-0 pt-4">
          <Link
            href={"/"}
            className="group flex items-center gap-1 w-fit h-fit hover:text-red-600"
          >
            <p className="lg:text-[3.4rem] pb-2">Pentol Ngetop,</p>
            <Link2
              size={28}
        ...
        <TextType
          ...
          showCursor={true}
          cursorCharacter="|"
          className="lg:text-2xl text-xl lg:font-medium font-normal text-neutral-800 lg:mb-6 mb-4 font-poppins w-fit lg:h-fit h-14"
        />
        <div className="flex gap-4">
          <ButtonMengkilap
            ...
            className={
              "lg:text-[1rem] text-[0.79rem] gradiasi-btn-merah lg:rounded-full rounded-lg font-semibold w-44 py-3 hover:ring-2 hover:ring-red-800 hover:ring-offset-2"
            }
          />
          <BtnGeserAtas
            text={"Hubungi Kami"}
            styleText={
              "gradiasi-btn-merah text-yellow-300 font-semibold lg:text-[1rem] text-[0.79rem] lg:rounded-full rounded-lg w-44"
            }
