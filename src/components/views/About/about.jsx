...
export default function About() {
  return (
    <>
      <section className="lg:h-[120vh] h-fit font-poppins flex flex-col justify-start items-center gradiasi-btn-merah lg:py-16 py-10 lg:px-16 px-8 rounded-t-[5vw] shadow-[0px_-5px_16px] shadow-black/20 overflow-hidden">
